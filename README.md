...
| SeelansTyres-Gateways-WebBffSolution | [![Build Status](https://dev.azure.com/Shaylen/Personal/_apis/build/status%2FSeelansTyres-Gateways-WebBffSolution?branchName=master)](https://dev.azure.com/Shaylen/Personal/_build/latest?definitionId=17&branchName=master) |
...
* [Documenting an ASP.NET Core 6 Web API Using Swagger](https://www.pluralsight.com/courses/asp-dot-net-core-6-web-api-documenting-swagger)
  * Author: Kevin Dockx
* [Globalization and Internationalization in .NET 6](https://www.pluralsight.com/courses/dot-net-6-globalization-internationalization)
  * Author: Filip Ekberg
...
* [Visual Studio 2022](https://visualstudio.microsoft.com/downloads/) 17.10.5 or later
* Latest .NET SDK [6](https://dotnet.microsoft.com/en-us/download/dotnet/6.0) and [8](https://dotnet.microsoft.com/en-us/download/dotnet/8.0)
