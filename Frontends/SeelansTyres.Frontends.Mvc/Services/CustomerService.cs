...
public class CustomerService : ICustomerService
{
    ...
    public async Task<(CustomerModel?, bool, List<string>)> CreateAsync(RegisterModel registerModel)
    {
        ...
        try
        {
            ...
            var response = await client.PostAsync("api/customers", JsonContent.Create(await registerModel.EncryptAsync(client, configuration)));
    ...
    public async Task UpdateAsync(UpdateAccountModel updateAccountModel)
    {
        ...
        var response = await client.PutAsync($"api/customers/{customerId}", JsonContent.Create(await updateAccountModel.EncryptAsync(client, configuration)));
    ...
    public async Task<bool> DeleteAsync(string password)
    {
        ...
        var response = await client.PostAsync($"api/customers/{customerId}/verifypassword", JsonContent.Create(await passwordModel.EncryptAsync(client, configuration)));
    ...
    public async Task ResetPasswordAsync(Guid customerId, string password)
    {
        ...
        await client.PutAsync($"api/customers/{customerId}/resetpassword", JsonContent.Create(await passwordModel.EncryptAsync(client, configuration)));
    }
